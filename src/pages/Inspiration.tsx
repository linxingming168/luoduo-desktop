...
import { Lightbulb, ThumbsUp, MessageSquare, Clock, Plus } from 'lucide-react';
...
const mockIdeas: Idea[] = [
  ...
  { id: 4, title: '智能体协作工作流', desc: '多个智能体按流程自动接力完成任务', category: '自动化', votes: 9, comments: 4, time: '1周前', status: '待评估' },
];

const categories = ['全部', '效率工具', '智能体', '交互体验', '自动化'];
