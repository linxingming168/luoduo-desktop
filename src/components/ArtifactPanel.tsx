...
// 右侧预览面板：HTML 直接在 iframe 里运行（可玩游戏），也可看源码 / 复制 / 下载
// 支持左边缘拖拽调宽、Esc 关闭
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <button onClick={doCopy} title={copied ? '已复制' : '复制代码'} style={{ ...btnStyle, color: copied ? '#1a1a1a' : '#4b5563' }}>
          {copied ? <Check size={14} /> : <Copy size={14} />}
        </button>
        <button onClick={() => downloadArtifact(artifact)} title="下载文件" style={btnStyle}>
          <Download size={14} />
        </button>
